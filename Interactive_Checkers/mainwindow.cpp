...
void MainWindow::on_pushButton_65_clicked()
{
    ...
    Position* pos = new_Position(8);
        /// filling pos->arr[][] ---------------------------------------------------------------------
    qDebug() << " !info : Start filling pos->arr " << '\n';
    fillPosition(pos);
    ...
    qDebug() << " !info : finish filling pos->arr" << '\n';
        /// ---------- end filling pos->arr[][] -----------------------------------------------------

    printPosition(pos);

        /// -------- main algorithm of game -----------------------------------------------------------
        qDebug() << " !info : Start main game algorithm ";
    int kol_hit_b = check_black_hit(pos);
    int kol_hit_B = check_Black_hit(pos);
    qDebug() << " !info : kol_hit_b = " << kol_hit_b << '\n'
             << " kol_hit_B = " << kol_hit_B;
    if(kol_hit_b + kol_hit_B > 0){
        ...
        pos = bBlack_move(pos, 1);
    }
    qDebug() << " !info : result position ";
    printPosition(pos);
        qDebug() << " !info : End main game algorithm ";
        /// -------- end of main algorithm of game -----------------------------------------------------------

       /// ---------- Printing result to UI -----------------------------------------------------------------
       qDebug() << " !info : Start Printing result to UI ";
    ...
    ui->pushButton_64->setText(get_string(pos->arr[8][8]));
       qDebug() << " !info : End Printing result to UI ";
